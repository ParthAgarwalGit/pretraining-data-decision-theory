...
| P1-12 | Publish derived tables; Phase 1 memo | IN PROGRESS | [#21](https://github.com/ParthAgarwalGit/pretraining-data-decision-theory/pull/21) | memo written (`docs/findings/phase1_memo.md`): evidence supports neither literal framing cleanly -- recommends the bias/variance decomposition and P1-02's ambiguity finding as co-equal headline claims; HF push (`Parth4105/pdt-datadecide-analysis`) held pending explicit PI confirmation, per standing practice of never pushing to HF without asking first |
