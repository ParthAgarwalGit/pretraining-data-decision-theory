...
| P1-07 | Plug-in bound and empirical coverage | IN PROGRESS | | code+tests done; Monte-Carlo run (B=500 x full grid) about to launch in background (~2-3hr estimated) |
